...
def simulate_point(index, row, dwsim_path, sim_path):
    ...
    clr.AddReference(os.path.join(dwsim_path, "DWSIM.Thermodynamics.ThermoC.dll"))
...
if __name__ == '__main__':
    ...
    sim_path = r"Z:\GoogleDrive\uem\Doutorado\Ensaios\SAF\SAF_8_08_08_2025\SAF_kinetics_paper_code_with_WGS\lumped_model\dwsim_bench_lumped_model.dwxmz"
    ...
    # Save final results
    kinetic_data.to_pickle('kinetic_data_dwsim.pkl')
    kinetic_data.to_excel('kinetic_data_dwsim.ods')
