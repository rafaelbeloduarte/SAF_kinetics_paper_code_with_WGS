...
if __name__ == '__main__':
    ...
    sim_path = r"Z:\GoogleDrive\uem\Doutorado\Ensaios\SAF\SAF_8_08_08_2025\SAF_kinetics_paper_code_with_WGS\dwsim_bench_model_low.dwxmz"
    ...
    # Save final results
    kinetic_data.to_pickle('kinetic_data_dwsim_low.pkl')
    kinetic_data.to_excel('kinetic_data_dwsim_low.ods')
